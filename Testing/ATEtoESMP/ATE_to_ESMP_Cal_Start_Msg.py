...
########################################################################################################################
class ATE_ESMP_CAL_Start_MSG():
    def __init__(self):
        super(ATE_ESMP_CAL_Start_MSG, self).__init__()
        self.Packet = []
        ################################################################################################################
    ...
    def StartCalPacket(self,SM=2,Mscode=1,seqNo=1,msglen=2,footer=2):
        #self.Packet =[]
...
if __name__ == "__main__":
    app = ATE_ESMP_CAL_Start_MSG()
    app.StartCalPacket(SM=0xAAAA, Mscode=5001, seqNo=1, msglen=5,footer=0xEEEE)
