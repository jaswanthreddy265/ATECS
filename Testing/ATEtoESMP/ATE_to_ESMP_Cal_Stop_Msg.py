...
########################################################################################################################
class ATE_ESMP_CAL_Stop_MSG():
    def __init__(self):
        super(ATE_ESMP_CAL_Stop_MSG, self).__init__()
        self.Packet=[]
        ################################################################################################################
        ...
        self.CAL_MSG = b'CALSTOP'
        if self.CAL_MSG == b'CALSTOP':
    ...
    def StopCalPacket(self,SM=2,Mscode=1,seqNo=1,msglen=2,footer=2):
        #self.Packet =[]
...
if __name__ == "__main__":
    app = ATE_ESMP_CAL_Stop_MSG()
    app.StopCalPacket(SM=0xAAAA, Mscode=5002, seqNo=1, msglen=5, footer=0xEEEE)