...
########################################################################################################################
class ATE_ESMP_DataCal_External_Mode_MSG():
    def __init__(self):
        super(ATE_ESMP_DataCal_External_Mode_MSG, self).__init__()
        self.Packet = []
    #########################################################################################################################
        ...
        self.CAL_MSG = b'CALSTART'  ##### DataCal_External_Mode msg to be written
    ...
    def DataCalExternalModePacket(self,SM=2,Mscode=1,seqNo=1,msglen=2, RB=0,  CF=500, RFATT1=0, RFATT2=0, RFATT3=0, RFATT4=0, RFATT5=0,
...
if __name__ == "__main__":
    app = ATE_ESMP_DataCal_External_Mode_MSG()
    app.DataCalExternalModePacket(SM=0xAAAA,Mscode=5004,seqNo=1,msglen=22,RB=1//1, CF=2000//1, RFATT1=0//2, RFATT2=0//2, RFATT3=0//2, RFATT4=0//2,
