...
########################################################################################################################
class ATE_ESMP_Start_WarnerRx_Cal_MSG():
    def __init__(self):
        super(ATE_ESMP_Start_WarnerRx_Cal_MSG, self).__init__()
        self.Packet = []
        ################################################################################################################
    ...
    def StartWarnerPacket(self,SM=2,Mscode=1,seqNo=1,msglen=2,footer=2):
        #self.Packet =[]
...
if __name__ == "__main__":
    app = ATE_ESMP_Start_WarnerRx_Cal_MSG()
    app.StartWarnerPacket(SM=0xAAAA, Mscode=5008, seqNo=1, msglen=5, footer=0xEEEE)
